            ...
            focus_items.append(
                {
                    ...
                    "meaning_secondary": str(entry.get("meaning_secondary") or "").strip(),
                    "function": str(entry.get("function") or "").strip(),
                    "example_script": str(entry.get("example_script") or "").strip(),
                    "example_romanized": str(entry.get("example_romanized") or "").strip(),
                    "example_literal_translation": str(entry.get("example_literal_translation") or "").strip(),
                    "example_secondary_translation": str(entry.get("example_secondary_translation") or "").strip(),
