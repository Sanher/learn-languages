...
CONDITIONAL_PATTERNS_SEEDS: tuple[FocusItemSeed, ...] = (
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_EXPRESSION,
        script="たら",
        reading_kana="たら",
        reading_romanized="tara",
        meaning_en="if / when",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=100,
        covers_competencies=("conditionals",),
        stage_min="advanced",
    ...
    FocusItemSeed(
        ...
        script="なら",
        reading_kana="なら",
        reading_romanized="nara",
        meaning_en="if it is the case that",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=96,
        covers_competencies=("conditionals",),
    ...
    FocusItemSeed(
        ...
        covers_competencies=("conditionals",),
        stage_min="advanced",
        example_script="時間があれば、手伝います。",
        example_romanized="jikan ga areba, tetsudaimasu",
        example_literal_translation="if there is time, will help",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="もし",
        reading_kana="もし",
        reading_romanized="moshi",
        meaning_en="if",
        mandatory=False,
        exam_relevant=False,
        suggested_priority=82,
        covers_competencies=("conditionals",),
        stage_min="advanced",
        example_script="もし雨なら、家にいます。",
        example_romanized="moshi ame nara, ie ni imasu",
        example_literal_translation="if it is rain, stay at home",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_EXPRESSION,
        script="ても",
        reading_kana="ても",
        reading_romanized="temo",
        meaning_en="even if",
        mandatory=False,
        exam_relevant=False,
        ...
        example_literal_translation="even if it is late, will go",
    ),
)

SUBORDINATION_PATTERNS_SEEDS: tuple[FocusItemSeed, ...] = (
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="とき",
        reading_kana="とき",
        reading_romanized="toki",
        meaning_en="when / at the time",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=100,
        covers_competencies=("subordination",),
        stage_min="advanced",
        example_script="日本に行くとき、切符を買います。",
        example_romanized="nihon ni iku toki, kippu o kaimasu",
        example_literal_translation="when going to Japan, buy a ticket",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_EXPRESSION,
        script="前に",
        reading_kana="まえに",
        reading_romanized="mae ni",
        meaning_en="before",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=96,
        ...
        example_literal_translation="before sleeping, read a book",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_EXPRESSION,
        script="あとで",
        reading_kana="あとで",
        reading_romanized="ato de",
        meaning_en="afterwards",
        mandatory=False,
        exam_relevant=True,
        suggested_priority=90,
        covers_competencies=("subordination", "discourse_connectors"),
        stage_min="advanced",
        example_script="会議のあとで連絡します。",
        example_romanized="kaigi no ato de renraku shimasu",
        example_literal_translation="after the meeting, contact",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="ところ",
        reading_kana="ところ",
        reading_romanized="tokoro",
        meaning_en="point / moment / place in an action",
        mandatory=False,
        exam_relevant=False,
        suggested_priority=84,
        covers_competencies=("subordination",),
        ...
        example_literal_translation="just at the point of leaving",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="こと",
        reading_kana="こと",
        reading_romanized="koto",
        meaning_en="nominalized action / abstract thing",
        mandatory=False,
        exam_relevant=False,
        suggested_priority=80,
        covers_competencies=("subordination",),
        ...
        example_literal_translation="returning early is important",
    ),
)

VOICE_AND_VALENCY_SEEDS: tuple[FocusItemSeed, ...] = (
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="開ける",
        reading_kana="あける",
        reading_romanized="akeru",
        meaning_en="open something",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=100,
        covers_competencies=("voice_and_valency",),
        stage_min="advanced",
        example_script="窓を開けます。",
        example_romanized="mado o akemasu",
        example_literal_translation="open the window",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="開く",
        reading_kana="あく",
        reading_romanized="aku",
        meaning_en="become open",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=96,
        covers_competencies=("voice_and_valency",),
        ...
        example_literal_translation="the door opens",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="壊す",
        reading_kana="こわす",
        reading_romanized="kowasu",
        ...
        covers_competencies=("voice_and_valency",),
        stage_min="advanced",
        example_script="機械を壊しました。",
        example_romanized="kikai o kowashimashita",
        example_literal_translation="broke the machine",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="壊れる",
        reading_kana="こわれる",
        reading_romanized="kowareru",
        meaning_en="break / become broken",
        mandatory=False,
        exam_relevant=True,
        suggested_priority=88,
        covers_competencies=("voice_and_valency",),
        ...
        example_literal_translation="the machine broke",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_EXPRESSION,
        script="られました",
        reading_kana="られました",
        reading_romanized="raremashita",
        meaning_en="was ...ed",
        mandatory=False,
        exam_relevant=False,
        suggested_priority=78,
        ...
        example_literal_translation="was praised by the teacher",
    ),
)

DISCOURSE_CONNECTORS_SEEDS: tuple[FocusItemSeed, ...] = (
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="しかし",
        reading_kana="しかし",
        reading_romanized="shikashi",
        meaning_en="however",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=100,
        covers_competencies=("discourse_connectors",),
        stage_min="advanced",
        example_script="行きたいです。しかし、時間がありません。",
        example_romanized="ikitai desu. shikashi, jikan ga arimasen",
        example_literal_translation="want to go. however, there is no time",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="そのため",
        reading_kana="そのため",
        reading_romanized="sono tame",
        meaning_en="therefore / because of that",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=96,
        covers_competencies=("discourse_connectors",),
        ...
        example_romanized="densha ga okuremashita. sono tame, kaigi ni okuremashita",
    ...
    FocusItemSeed(
        ...
        covers_competencies=("discourse_connectors",),
        stage_min="advanced",
        example_script="便利です。一方で、費用がかかります。",
        example_romanized="benri desu. ippou de, hiyou ga kakarimasu",
        example_literal_translation="it is convenient. on the other hand, it costs money",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="つまり",
        reading_kana="つまり",
        reading_romanized="tsumari",
        ...
        covers_competencies=("discourse_connectors",),
        stage_min="advanced",
        example_script="つまり、今日は延期です。",
        example_romanized="tsumari, kyou wa enki desu",
        example_literal_translation="in other words, today is postponed",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="それでも",
        reading_kana="それでも",
        reading_romanized="soredemo",
        meaning_en="even so / nevertheless",
        mandatory=False,
        exam_relevant=False,
        suggested_priority=82,
        covers_competencies=("discourse_connectors", "conditionals"),
        stage_min="advanced",
...
FORMAL_REGISTER_SEEDS: tuple[FocusItemSeed, ...] = (
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="ございます",
        reading_kana="ございます",
        reading_romanized="gozaimasu",
        meaning_en="formal is / there is",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=100,
        covers_competencies=("formal_register",),
        stage_min="advanced",
        example_script="ご不明な点がございます。",
        example_romanized="gofumei na ten ga gozaimasu",
        example_literal_translation="there is an unclear point",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_WORD,
        script="いたします",
        reading_kana="いたします",
        reading_romanized="itashimasu",
        meaning_en="humbly do",
        mandatory=True,
        exam_relevant=True,
        suggested_priority=96,
        covers_competencies=("formal_register",),
        ...
        example_literal_translation="I will confirm it here",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_EXPRESSION,
        script="いただけますか",
        reading_kana="いただけますか",
        reading_romanized="itadakemasu ka",
        ...
        covers_competencies=("formal_register",),
        stage_min="advanced",
        example_script="少々お待ちいただけますか。",
        example_romanized="shoushou omachi itadakemasu ka",
        example_literal_translation="could you please wait a moment",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_EXPRESSION,
        script="恐れ入りますが",
        reading_kana="おそれいりますが",
        reading_romanized="osore irimasu ga",
        meaning_en="I am sorry to trouble you, but",
        mandatory=False,
        exam_relevant=False,
        suggested_priority=88,
        covers_competencies=("formal_register",),
        ...
        example_romanized="osore irimasu ga, mou ichido onegai itashimasu",
        example_literal_translation="I am sorry to trouble you, but please once more",
    ),
    FocusItemSeed(
        item_type=FOCUS_ITEM_TYPE_EXPRESSION,
        script="お願いいたします",
        reading_kana="おねがいいたします",
        reading_romanized="onegai itashimasu",
        ...
        covers_competencies=("formal_register",),
        stage_min="advanced",
        example_script="ご確認をお願いいたします。",
        example_romanized="gokakunin o onegai itashimasu",
        example_literal_translation="please confirm",
    ),
)
...
JA_FOCUS_ITEM_SEEDS_BY_TOPIC: dict[str, tuple[FocusItemSeed, ...]] = {
    ...
    "conditional_patterns": CONDITIONAL_PATTERNS_SEEDS,
    "subordination_patterns": SUBORDINATION_PATTERNS_SEEDS,
    "voice_and_valency": VOICE_AND_VALENCY_SEEDS,
    "discourse_connectors": DISCOURSE_CONNECTORS_SEEDS,
    "formal_register_patterns": FORMAL_REGISTER_SEEDS,
}
